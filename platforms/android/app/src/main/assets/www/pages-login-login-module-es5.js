(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-login-login-module"], {
    ...
    function srcAppPagesLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var zilliqa = new Zilliqa('https://dev-api.zilliqa.com');

      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(vibration, alertController, nativeStorage, route) {
        ...
        _createClass(LoginPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.nativeStorage.getItem('wallet').then(function (data) {
              _this.walletData = data;
            }, function (error) {
              _this.route.navigate(['/getting-started']);
            });
          }
        }, {
          key: "showPopup",
          ...
          value: function savePin() {
            ...
            if (totalX == 0) {
              var _bytes = crypto_js__WEBPACK_IMPORTED_MODULE_2__["AES"].decrypt(this.walletData.privKey, this.selectedPin);

              var key = _bytes.toString(crypto_js__WEBPACK_IMPORTED_MODULE_2__["enc"].Utf8);
